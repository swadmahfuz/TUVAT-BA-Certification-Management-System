<aside class="admin-sidebar" id="adminSidebar">
    ...
    <nav class="sidebar-nav" aria-label="Administration">
        ...
        <x-admin.disabled-action
            ...
            :active="request()->routeIs('client.add')"
        ...
        <x-admin.disabled-action
            ...
            :active="request()->routeIs('certificate.add') || request()->routeIs('certificate.addForClient')"
        ...
        <x-admin.disabled-action
            ...
            permission="mutate"
            :href="route('standards.manage')"

            :message="\App\Services\PermissionService::deniedMessage()"

            :active="request()->routeIs('standards.manage')"
        ...
        <x-admin.disabled-action
            ...
            permission="mutate"
            :href="route('accreditationBodies.manage')"

            :message="\App\Services\PermissionService::deniedMessage()"

            :active="request()->routeIs('accreditationBodies.manage')"
