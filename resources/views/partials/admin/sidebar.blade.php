<aside class="admin-sidebar" id="adminSidebar">
    <div class="sidebar-brand">
        ...
        <div>
            ...
            <small>BA Certification CVS</small>
        </div>
    ...
    <nav class="sidebar-nav" aria-label="Administration">
        ...
        <a class="sidebar-link {{ request()->routeIs('clients') ? 'active' : '' }}" href="{{ route('clients') }}">
            <i class="fa-solid fa-building"></i><span>All Clients</span>
        </a>
        @canMutate
        <a class="sidebar-link {{ request()->routeIs('client.add') ? 'active' : '' }}" href="{{ route('client.add') }}">
            <i class="fa-solid fa-plus"></i><span>Add Client</span>
        </a>
        @endcanMutate

        <div class="sidebar-label">Certificates</div>
        @canMutate
        <a class="sidebar-link {{ request()->routeIs('certificate.add') || request()->routeIs('certificate.addForClient') ? 'active' : '' }}" href="{{ route('certificate.add') }}">
            <i class="fa-solid fa-certificate"></i><span>Add Certificate</span>
        </a>
        @endcanMutate
        ...
        <div class="sidebar-label">Audit Tracking</div>
        <a class="sidebar-link {{ request()->routeIs('upcomingAudits') ? 'active' : '' }}" href="{{ route('upcomingAudits') }}">
            <i class="fa-solid fa-calendar-days"></i><span>Upcoming Audits</span>
        </a>
        <a class="sidebar-link {{ request()->routeIs('expiredCertificates') ? 'active' : '' }}" href="{{ route('expiredCertificates') }}">
            <i class="fa-solid fa-triangle-exclamation"></i><span>Expired Certificates</span>
        </a>

        <div class="sidebar-label">Reference Data</div>
        @canMutate
        <a class="sidebar-link {{ request()->routeIs('standards.manage') ? 'active' : '' }}" href="{{ route('standards.manage') }}">
            <i class="fa-solid fa-layer-group"></i><span>Standards</span>
        </a>
        <a class="sidebar-link {{ request()->routeIs('accreditationBodies.manage') ? 'active' : '' }}" href="{{ route('accreditationBodies.manage') }}">
            <i class="fa-solid fa-building-columns"></i><span>Accreditation Bodies</span>
        </a>
        @endcanMutate
