...
<html>
    <head>
        ...
        <title>TÜV Austria BIC | Add BA Client</title>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="remarks"
                                                      ...
                                                      class="form-control"
                                                      rows="3"
                                                      placeholder="Enter remarks, if any">{{ old('remarks') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-4">
                                            <button type="submit" class="btn btn-success w-100">
                                                <i class="fa-solid fa-floppy-disk me-1"></i> Save Client
                                            </button>
                                        </div>
